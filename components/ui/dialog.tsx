    ...
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "w-full max-w-lg bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl shadow-black/40",
          "focus:outline-none",
          className
        )}
      >
        ...
        {(title || description) && (
          <div className="flex items-start justify-between gap-4 px-6 pt-6 pb-0">
            ...
            <DialogPrimitive.Close className="text-slate-500 hover:text-slate-300 transition-colors mt-0.5">
              <X className="w-5 h-5" />
